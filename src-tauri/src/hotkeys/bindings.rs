...
//! One profile file `hotkeys/default.json` next to the exe holds every binding.
//!
...
/// The portable profile path: `<exe dir>/hotkeys/default.json` (sibling to the
/// screenshots/ and logs/ dirs — state::state_dir() resolves next to the exe).
